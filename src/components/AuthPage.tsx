        ...
        <div className="mt-6 bg-white py-8 px-5 sm:px-8 shadow-sm rounded-3xl border border-[#E0E7E0]">
          ...
          <div className="mt-5">
            <div className="relative flex items-center">
              ...
              <span className="px-3 text-[10px] text-gray-400 font-mono uppercase">Or continue with</span>
              <div className="flex-1 border-t border-[#E0E7E0]" />
            </div>
            <button
              onClick={handleGoogleSignIn}
              disabled={isLoading}
              className="mt-4 w-full flex items-center justify-center gap-2.5 py-3 px-4 border border-[#E0E7E0] rounded-xl bg-[#F7F9F7] hover:bg-[#E6F4EA] hover:border-[#008751] text-xs font-bold text-gray-700 hover:text-[#008751] transition cursor-pointer"
            >
